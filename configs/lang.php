...
if ($_SESSION['lang'] === 1) {
    $smarty->assign('LANG_CONTACT', 'Kontakt');
    $smarty->assign('LANG_FORM_CONTACT', 'Kontakt');
    $smarty->assign('LANG_HOW', 'Jak do nas dojechać?');
    $smarty->assign('LANG_NEWS', 'Wpisz swój e-mail aby otrzymywać informacje o promocjach');
    $smarty->assign('LANG_ABOUT', 'O nas');
    $smarty->assign('LANG_HELP', 'Pomoc');
    $smarty->assign('LANG_INFO', 'Dane naszej firmy');
    $smarty->assign('LANG_WRITE', 'Napisz do nas');
    $smarty->assign('LANG_NAME', 'Imię i nazwisko');
    $smarty->assign('LANG_EMAIL', 'Adres email');
    $smarty->assign('LANG_CONTENT', 'Treść');
    $smarty->assign('LANG_TEL', 'Telefon');
    $smarty->assign('LANG_SEND', 'Wyślij wiadomość');
    ...
    $smarty->assign('LANG_FORM_CONTACT', 'Kontakt');
    $smarty->assign('LANG_HOW', 'How to find us?');
