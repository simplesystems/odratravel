...
var fileManager = {
    init: function() {
        ...
        $('.fileContainer').html('Files are being lodaded.. plase wait');
...
//                remove.appendTo(div);
    ...
    addPaginator: function() {
        ...
        if (pages > 1) {
            ...
            var a = $('<a>').attr({'href': 'prev', 'class': 'pagination-page previous'}).html('«Previous').appendTo(li);
            ...
            var li = $('<li>').appendTo(div);
            var a = $('<a>').attr({'href': 'next', 'class': 'pagination-page next'}).html('Next»').appendTo(li);
    ...
    addMaxList: function() {
        ...
        var span = $('<span>').appendTo(div).html('Items on page:');
    ...
    addFilters: function() {
        ...
        var span = $('<span>').appendTo(div).html('Filter by Tags:');
        ...
        var checkboxlabel = $('<span>').html('Show too small images ').appendTo(checkboxwrapper);
    ...
    addImage: function(img) {
        ...
        var y = obj.data('imagey');
        var size = {};
        if (obj.data('imagex') < 200 || obj.data('imagey') < 200) {
            size['x'] = obj.data('imagex');
            size['y'] = obj.data('imagey');
        }
        else {
            size = url.calculate(x, y, 200, 200);
        }
